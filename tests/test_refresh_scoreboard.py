...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for expected in (
            ...
            "rankwidth kernels map=2/250 ns max items=20, join=2/500 ns max items=22, labelled-map=2/200 ns max items=11, labelled=2/440 ns max items=17, fourier-map=1/70 ns max items=7, fourier=1/80 ns max items=8, labelled-fourier-map=1/60 ns max items=6, labelled-fourier=1/75 ns max items=7",
